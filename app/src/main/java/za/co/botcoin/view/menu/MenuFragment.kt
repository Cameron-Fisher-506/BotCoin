...
class MenuFragment : Fragment(R.layout.menu_fragment) {
    ...
    private fun addSetResistancePriceCounterOptionListener() {
        this.binding.setResistancePriceCounterLinearLayoutCompat.setOnClickListener {
    ...
    private fun addSetSupportPriceCounterOptionListener() {
        this.binding.setSupportPriceCounterLinearLayoutCompat.setOnClickListener {
    ...
    private fun addTrailingStartOptionListener() {
        this.binding.trailingStartLinearLayoutCompat.setOnClickListener {
    ...
    private fun addTrailingStopOptionListener() {
        this.binding.trailingStopLinearLayoutCompat.setOnClickListener {
    ...
    private fun addLunoApiOptionListener() {
        this.binding.lunoApiOptionLinearLayoutCompat.setOnClickListener {
    ...
    private fun addDonateListener() {
        this.binding.donateOptionLinearLayoutCompat.setOnClickListener {
    ...
    private fun addSmartTrendDetectorMarginListener() {
        this.binding.setSmartTrendDetectorMarginLinearLayoutCompat.setOnClickListener {
